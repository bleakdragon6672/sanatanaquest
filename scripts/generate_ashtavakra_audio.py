#!/usr/bin/env python3
"""Generate Sanskrit audio for all Ashtavakra Gita verses using Edge TTS."""
import asyncio
import os
import re
import sys
...
def extract_verses(ts_path):
    """Extract (verse_id, sanskrit_text) from ashtavakra-gita-data.ts."""
...
async def main():
    ts_path = '/Users/samarthrao/prodgita/src/lib/ashtavakra-gita-data.ts'
    output_dir = '/Users/samarthrao/prodgita/public/audio/ashtavakra-gita'
    ...
    print(f"Found {len(verses)} Ashtavakra Gita verses to generate")
