#!/usr/bin/env python3
"""Generate Sanskrit audio for all Yoga Sutra verses using Edge TTS."""
import asyncio
import os
import re
import sys
...
def extract_verses(ts_path):
    """Extract (verse_id, sanskrit_text) from yoga-sutras-data.ts."""
...
async def main():
    ts_path = '/Users/samarthrao/prodgita/src/lib/yoga-sutras-data.ts'
    output_dir = '/Users/samarthrao/prodgita/public/audio/yoga-sutras'
    ...
    print(f"Found {len(verses)} Yoga Sutra verses to generate")
