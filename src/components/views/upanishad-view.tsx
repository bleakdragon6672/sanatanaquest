          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-xs text-muted-foreground mt-2 line-clamp-2 leading-relaxed">{u.theme}</p>
                <div className="mt-3">
  ...
  return (
    <div className="space-y-5">
      ...
      <KindleBookReader
        ...
        verses={upanishad.verses.map((v, i) => ({
          ...v,
          chapter: upanishad.name,
          verse: i + 1,
        }))}
            ...
            <div className="relative rounded-xl overflow-hidden">
              ...
              <div className="relative px-5 py-4 sm:px-6 sm:py-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.15em] text-primary/60 font-semibold" style={{ fontFamily: 'var(--font-cinzel), sans-serif' }}>Commentary</p>
                    <p className="text-[9px] uppercase tracking-widest text-muted-foreground/50">Explanation</p>
                  </div>
                </div>
                <p
